export default function TheMotherCircleWebsite() {
  const blogPosts = [
    {
  ...
  return (
    <div className="min-h-screen bg-[#fdf7f2] text-[#4a3f39] font-sans">
      {/* Hero Section */}
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="rounded-2xl bg-[#b87b6a] px-8 py-4 text-sm font-semibold text-white shadow-lg transition hover:scale-105">
                Buy the Book
              </button>

              <button className="rounded-2xl border border-[#b87b6a] px-8 py-4 text-sm font-semibold text-[#b87b6a] transition hover:bg-[#b87b6a] hover:text-white">
                Read the Blog
              </button>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-sm rounded-[2rem] bg-white p-6 shadow-2xl">
              <div className="aspect-[3/4] rounded-[1.5rem] bg-gradient-to-b from-[#d9b2a7] to-[#f4e3db] p-6 shadow-inner">
                <div className="flex h-full flex-col items-center justify-center rounded-[1.2rem] border border-white/60 bg-white/30 backdrop-blur-sm">
                  ...
                  <h2 className="px-6 text-center text-4xl font-bold text-white">
                    The Mother Circle
                  </h2>
                </div>
              </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mb-5 text-lg leading-relaxed text-[#665a54]">
              The Mother Circle was created to give mothers a place to feel seen, heard, and understood. Through honest stories and emotional reflections, this book reminds readers that motherhood comes with both beauty and challenges.
            </p>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-3xl bg-[#fdf7f2] p-8 shadow-sm">
              <h3 className="mb-3 text-2xl font-semibold">
                Real Stories
              </h3>

              <p className="leading-relaxed text-[#665a54]">
                Honest experiences from mothers navigating every stage of life.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-[#fdf7f2] p-8 shadow-sm">
              ...
              <p className="leading-relaxed text-[#665a54]">
                Gentle reminders that no mother is meant to carry everything alone.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-[#fdf7f2] p-8 shadow-sm">
              ...
              <p className="leading-relaxed text-[#665a54]">
                A space where motherhood is celebrated with honesty and grace.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-[#fdf7f2] p-8 shadow-sm">
              ...
              <p className="leading-relaxed text-[#665a54]">
                Thoughtful words to revisit during difficult or meaningful seasons.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-20 md:px-16 lg:px-24">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <button className="w-fit rounded-2xl border border-[#b87b6a] px-6 py-3 font-semibold text-[#b87b6a] transition hover:bg-[#b87b6a] hover:text-white">
              View All Posts
            </button>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full rounded-2xl border border-[#ead8d1] px-5 py-4 outline-none transition focus:border-[#b87b6a]"
              />
      ...
      <footer className="border-t border-[#ead8d1] bg-[#fffaf7] px-6 py-10 md:px-16 lg:px-24">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-6 text-sm font-medium text-[#665a54]">
            <a href="#" className="transition hover:text-[#b87b6a]">
              Home
            </a>
